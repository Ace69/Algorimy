...
*/
	  ...
	  return((index+1) % (QUEUE_SIZE));             /* V případě řešení, smažte tento řádek! */
...
*/
	  ...
	  return(((q->f_index-1)==q->b_index)||((q->f_index==0) && (q->b_index==QUEUE_SIZE-1)));                  /* V případě řešení, smažte tento řádek! */
}
